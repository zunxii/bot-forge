...
export function HeroContent() {
  return (
    <div className="relative pt-2">
      <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-slate-200/80 bg-white/78 px-4 py-2 text-[12px] font-medium text-slate-600 shadow-[0_8px_20px_rgba(15,23,42,0.04)] backdrop-blur-xl">
      ...
      <h1 className="max-w-[620px] text-[60px] font-semibold leading-[0.95] tracking-[-0.06em] text-slate-950 sm:text-[68px] lg:text-[74px]">
        Turn your business
        <br />
        knowledge into a
        <br />
      ...
      <p className="mt-7 max-w-[560px] text-[15.5px] leading-8 text-slate-500 sm:text-[16px]">
      ...
      <div className="mt-8 flex flex-wrap items-center gap-4">
        <Link
          href="#"
          className="inline-flex h-12 items-center gap-2 rounded-2xl bg-slate-950 px-6 text-[14px] font-semibold text-white shadow-[0_18px_36px_rgba(15,23,42,0.18)] transition hover:-translate-y-0.5 hover:bg-slate-800"
        >
          Start for free
